package com.interviewiq.shared.logging;
...
class LogbackConfigurationTest {
    ...
    private LoggerContext configureWithProfile(String profile) {
        ...
        environment.setProperty("spring.application.name", "interviewiq");
    ...
    void deployedProfilesEmitOneJsonObjectPerLine() throws Exception {
        ...
        assertThat(json.path("service").asText()).isEqualTo("interviewiq");
    }
    ...
    private String encodeOneEvent(LoggerContext context, ch.qos.logback.core.Appender<ILoggingEvent> appender) {
        ...
        event.setLoggerName("com.interviewiq.session.service.InterviewRoomService");
