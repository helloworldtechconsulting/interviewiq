...
import com.interviewengine.candidate.infrastructure.CandidateImportBatchRepository;
import com.interviewengine.candidate.infrastructure.CandidateRepository;
import com.interviewengine.candidate.service.CandidateCsvParser.ParsedRow;
...
import com.interviewengine.shared.exception.SessionStateException;
...
public class CandidateImportService {
    ...
    public ImportResult confirmImport(UUID batchId, List<ParsedRow> rows) {
        ...
        if (importable.isEmpty()) {
            ...
            batchRepository.save(batch);
            throw new com.interviewengine.shared.exception.ValidationException(
