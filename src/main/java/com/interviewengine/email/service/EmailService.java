...
public class EmailService {
    ...
    private static final String INVITE_TEMPLATE = """
            ...
            <p>Hi %s,</p>
            <p>You have been invited to participate in an AI-powered interview on InterviewEngine.</p>
    ...
    public void sendOtpEmail(String to, OtpPurpose purpose, String otp, UUID companyId, UUID userId) {
        String subject = switch (purpose) {
            case EMAIL_VERIFICATION -> "Verify your InterviewEngine account";
            case PASSWORD_RESET     -> "Reset your InterviewEngine password";
            default                 -> "Your InterviewEngine verification code";
        };
    ...
    public void sendCandidateInviteEmail(String to, String candidateName, String companyName,
        ...
        String subject = "Interview invitation from " + companyName + " on InterviewEngine";
    ...
    public void sendReportReadyEmail(String to, String candidateName, String jobTitle,
        ...
        String body = SHELL.formatted(
                ...
                "This score is advisory only. InterviewEngine does not advance or reject any candidate — "
    ...
    public void sendLowBalanceEmail(String to, String companyName, long balancePaise,
        ...
        String body = SHELL.formatted(
                "Your InterviewEngine balance is running low",
