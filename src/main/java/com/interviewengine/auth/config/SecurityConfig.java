package com.interviewengine.auth.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.interviewengine.auth.service.TokenService;
import com.interviewengine.auth.web.filter.CandidateTokenAuthFilter;
import com.interviewengine.auth.web.filter.JwtAuthenticationFilter;
import com.interviewengine.auth.web.filter.OnboardRateLimitFilter;
import com.interviewengine.auth.web.filter.RateLimitFilter;
...
/**
 * Spring Security configuration for InterviewEngine.
 *
...
public class SecurityConfig {
     ...
     * and therefore cannot use {@link com.interviewengine.shared.web.GlobalExceptionHandler}.
     */
