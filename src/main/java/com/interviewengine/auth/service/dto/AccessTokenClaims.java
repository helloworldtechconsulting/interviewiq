 ...
 *
 * <p>Constructed by {@link com.interviewengine.auth.service.TokenService#validateAccessToken(String)}
 * after signature verification and expiry check succeed.  The filter then uses
 * these claims to build the {@link com.interviewengine.shared.security.EmployerPrincipal}
