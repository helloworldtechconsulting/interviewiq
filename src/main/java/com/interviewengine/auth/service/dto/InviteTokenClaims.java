package com.interviewengine.auth.service.dto;
 ...
 *
 * <p>Constructed by {@link com.interviewengine.auth.service.TokenService#validateInviteToken(String)}
 * after signature verification and expiry check succeed.  The candidate filter uses
 * these claims to build the {@link com.interviewengine.shared.security.CandidatePrincipal}.
 *
