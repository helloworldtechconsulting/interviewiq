package com.interviewengine.shared.metrics;
...
public class PipelineMetrics {
    ...
    public PipelineMetrics(MeterRegistry registry, EvaluationReportRepository reportRepository) {
        ...
        Gauge.builder("interviewengine.evaluation.queue.depth", pendingReports, AtomicLong::get)
                .description("Evaluation reports awaiting generation")
                .register(registry);

        Gauge.builder("interviewengine.evaluation.queue.oldest.age.seconds", oldestPendingAge, AtomicLong::get)
