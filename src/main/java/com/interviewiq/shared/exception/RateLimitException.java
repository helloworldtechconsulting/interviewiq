 ...
 * to wait before retrying. The {@link com.interviewiq.shared.web.GlobalExceptionHandler}
 * writes this value into the {@code Retry-After} response header.
 */
public class RateLimitException extends InterviewIqException {
    ...
    public String getErrorCode() {
        return com.interviewiq.shared.dto.ApiErrorResponse.ErrorCode.RATE_LIMIT_EXCEEDED;
    }
}
