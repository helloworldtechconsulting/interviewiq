...
/**
 * Canonical error envelope for all InterviewIQ API error responses.
 *
 ...
 * @param errorCode   machine-readable error identifier (matches {@link com.interviewiq.shared.exception.ErrorCode})
